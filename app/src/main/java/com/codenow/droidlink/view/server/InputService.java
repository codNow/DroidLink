...
public class InputService extends AccessibilityService {
	...
	public void onServiceConnected()
	{
		...
		isEnabled = sharedPreferences.getBoolean(Constants.PREFS_KEY_INPUT_LAST_ENABLED, !new Defaults(this).getViewOnly());
		scaling = sharedPreferences.getFloat(Constants.PREFS_KEY_SERVER_LAST_SCALING, new Defaults(this).getScaling());
