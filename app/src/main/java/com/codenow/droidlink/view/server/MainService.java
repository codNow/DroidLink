...
public class MainService extends Service {
    ...
    public final static String ACTION_START = "com.codenow.droidlink.ACTION_START";
    public final static String ACTION_STOP = "com.codenow.droidlink.ACTION_STOP";
    public static final String ACTION_CONNECT_REVERSE = "com.codenow.droidlink.ACTION_CONNECT_REVERSE";
    public static final String ACTION_CONNECT_REPEATER = "com.codenow.droidlink.ACTION_CONNECT_REPEATER";
    public static final String EXTRA_REQUEST_ID = "com.codenow.droidlink.EXTRA_REQUEST_ID";
    public static final String EXTRA_REQUEST_SUCCESS = "com.codenow.droidlink.EXTRA_REQUEST_SUCCESS";
    public static final String EXTRA_HOST = "com.codenow.droidlink.EXTRA_HOST";
    public static final String EXTRA_PORT = "com.codenow.droidlink.EXTRA_PORT";
    public static final String EXTRA_REPEATER_ID = "com.codenow.droidlink.EXTRA_REPEATER_ID";
    public static final String EXTRA_ACCESS_KEY = "com.codenow.droidlink.EXTRA_ACCESS_KEY";
    public static final String EXTRA_PASSWORD = "com.codenow.droidlink.EXTRA_PASSWORD";
    public static final String EXTRA_VIEW_ONLY = "com.codenow.droidlink.EXTRA_VIEW_ONLY";
    public static final String EXTRA_SHOW_POINTERS = "com.codenow.droidlink.EXTRA_SHOW_POINTERS";
    public static final String EXTRA_SCALING = "com.codenow.droidlink.EXTRA_SCALING";
    public static final String EXTRA_FILE_TRANSFER = "com.codenow.droidlink.EXTRA_FILE_TRANSFER";
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        if(ACTION_HANDLE_MEDIA_PROJECTION_RESULT.equals(intent.getAction())) {
            ...
            Log.d(TAG, "resultData" + mResultData);
            DisplayMetrics displayMetrics = getDisplayMetrics(Display.DEFAULT_DISPLAY);
            SharedPreferences portPrefs = this.getSharedPreferences("PrefsPort", Context.MODE_PRIVATE);
            int port = portPrefs.getInt(PREFS_KEY_SERVER_LAST_PORT, mDefaults.getPort());
            ...
            boolean status = vncStartServer(displayMetrics.widthPixels,
                    ...
                    port,
                    name,
                    portPrefs.getString(PREFS_KEY_SERVER_LAST_PASSWORD, mDefaults.getPassword()));
            ...
            answer.putExtra(EXTRA_REQUEST_ID, portPrefs.getString(PREFS_KEY_SERVER_LAST_START_REQUEST_ID, null));
                    //PreferenceManager.getDefaultSharedPreferences(this).getString(PREFS_KEY_SERVER_LAST_START_REQUEST_ID, null));
        ...
        if(ACTION_HANDLE_WRITE_STORAGE_RESULT.equals(intent.getAction())) {
            ...
            if (mResultCode != 0 && mResultData != null) {
                SharedPreferences projectionPrefs = this.getSharedPreferences("PrefsProjection", Context.MODE_PRIVATE);
                DisplayMetrics displayMetrics = getDisplayMetrics(Display.DEFAULT_DISPLAY);
                int port = projectionPrefs.getInt(PREFS_KEY_SERVER_LAST_PORT, mDefaults.getPort());
                ...
                boolean status = vncStartServer(displayMetrics.widthPixels,
                        ...
                        port,
                        name,
                        projectionPrefs.getString(PREFS_KEY_SERVER_LAST_PASSWORD, mDefaults.getPassword()));
                        //PreferenceManager.getDefaultSharedPreferences(this).getString(PREFS_KEY_SERVER_LAST_PASSWORD, mDefaults.getPassword()));

                Intent answer = new Intent(ACTION_START);
                answer.putExtra(EXTRA_REQUEST_ID, projectionPrefs.getString(PREFS_KEY_SERVER_LAST_START_REQUEST_ID, null));
                        //PreferenceManager.getDefaultSharedPreferences(this).getString(PREFS_KEY_SERVER_LAST_START_REQUEST_ID, null));
                answer.putExtra(EXTRA_REQUEST_SUCCESS, status);
                sendBroadcast(answer);
        ...
        if(ACTION_HANDLE_INPUT_RESULT.equals(intent.getAction())) {
            ...
            SharedPreferences inputPrefs = this.getSharedPreferences("PrefsInput", Context.MODE_PRIVATE);
            ...
            writeStorageRequestIntent.putExtra(
                    EXTRA_FILE_TRANSFER,
                    inputPrefs.getBoolean(PREFS_KEY_SERVER_LAST_FILE_TRANSFER, mDefaults.getFileTransfer()));
        ...
        if(ACTION_START.equals(intent.getAction())) {
            ...
            final SharedPreferences prefs = this.getSharedPreferences("PrefsKeys", Context.MODE_PRIVATE);
    ...
    static void onClientConnected(long client) {
        ...
        try {
            SharedPreferences wakePrefs = instance.getSharedPreferences("WakePrefs", Context.MODE_PRIVATE);
            instance.mWakeLock.acquire();
            instance.mNumberOfClients++;
            instance.updateNotification();
            InputService.addClient(client, wakePrefs.getBoolean(PREFS_KEY_SERVER_LAST_SHOW_POINTERS, new Defaults(instance).getShowPointers()));
    ...
    private void startScreenCapture() {
        ...
        SharedPreferences scalePrefs = this.getSharedPreferences("PrefsScale", Context.MODE_PRIVATE);
        float scaling = scalePrefs.getFloat(Constants.PREFS_KEY_SERVER_LAST_SCALING, new Defaults(this).getScaling());
                //PreferenceManager.getDefaultSharedPreferences(this).getFloat(Constants.PREFS_KEY_SERVER_LAST_SCALING, new Defaults(this).getScaling());
    ...
    static int getPort() {
        try {
            SharedPreferences prefs = instance.getSharedPreferences("PortPref", Context.MODE_PRIVATE);
